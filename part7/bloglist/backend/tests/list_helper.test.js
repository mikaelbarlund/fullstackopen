...
describe('favouriteBlog', () => {
  ...
  test('of a bigger list is the third element', () => {
    const result = listHelper.favouriteBlog(blogs)
    expect(result).toEqual(blogs[2])
  })
  test('of empty listi is {}', () => {
...
describe('mostBlogs', () => {
  ...
  test('of a bigger list is Robert', () => {
...
describe('mostLikes', () => {
  ...
  test('of a bigger list is Edsger', () => {
